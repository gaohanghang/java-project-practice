package com.gaohanghang.easyexceldemo.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.gaohanghang"))
                // 对所有路径进行扫描
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("excel导入下载文档")
                .description("使用SpringBoot+easyexcel实现的一个简单的excel上传导入和下载的项目")
